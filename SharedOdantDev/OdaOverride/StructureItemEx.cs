...
public static class StructureItemEx
{
    ...
    {
        int listLength = ServerApi._GetLength(intPtr);
        var ODAItems = Enumerable.Range(0, listLength)
            .Select(x => oda.OdaOverride.ItemFactory.GetStorageItem(CreateByType(ServerApi._GetItem(intPtr, x))))
            .OfType<T>()
            .ToImmutableHashSet();
    ...
    public static IEnumerable<StructureItem> FindConfigItems(this StructureItem structureItem)
    {
        ...
        IntPtr configItemsIntPtr = ServerApi._FindConfigItems(structureItem.GetIntPtr(), xq);
    ...
    public static IEnumerable<Host> FindHosts(this Connection connection)
    {
        ...
        IntPtr configItemsIntPtr = ServerApi._Hosts(connection.GetIntPtr());
    ...
    public static StructureItem FindItem(this Item item, string path)
    {
        ...
        IntPtr configItemIntPtr = ServerApi._FindItem(item.GetIntPtr(), path);
    ...
    public static IEnumerable<Domain> FindDomains(this Domain domain)
    {
        ...
        IntPtr configItemsIntPtr = ServerApi._Domains(remoteDomain.GetIntPtr());

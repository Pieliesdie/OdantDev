...
using MaterialDesign.PropertyGrid.Controls;
using MaterialDesign.PropertyGrid.Implementations;

namespace MaterialDesign.PropertyGrid.Model;

public class PropertyField : INotifyPropertyChanged, IDisposable
{
    #region Members
    ...
    public Controls.PropertyGrid PropertyGrid { get; set; }
